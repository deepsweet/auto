...
import { gitOptions } from '@auto/git/test/git-options'
    ...
    [
      {
        ...
        messages: [
          {
            type: 'patch',
            prefix: gitOptions.prefixes.patch[0],
      ...
      [
        {
          ...
          messages: [
            {
              type: 'minor',
              prefix: gitOptions.prefixes.minor[0],
              value: 'minor'
            },
            {
              type: 'patch',
            ...
            {
              type: 'major',
              prefix: gitOptions.prefixes.major[0],
              value: 'major'
            }
          ]
        }
